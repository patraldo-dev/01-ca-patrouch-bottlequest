    ...
    <div class="container">
        ...
        <div class="bottles-grid">
            {#each data.bottles as bottle}
                <button class="bottle-card" class:active={activeBottle?.id === bottle.id} onclick={() => selectBottle(bottle)}>
                    ...
                    <div class="card-detail">
                        ...
                        {/if}
                        <div class="detail-row"><span>Status</span><span class="status-text status-{bottle.status}">{bottle.status}</span></div>
                    </div>
                    {/if}
                </button>
            {/each}
